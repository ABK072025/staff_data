...
SECRET_KEY = 'django-insecure-$b+c@kgv7@1(&h@bep1du5fxukiop#=p(gae&5^k5)@!(sp=dg'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ["staffdata.duckdns.org", "*"]
...
ROOT_URLCONF = 'staffdata_project.urls'
...
WSGI_APPLICATION = 'staffdata_project.wsgi.application'
